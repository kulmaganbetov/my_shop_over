...
ПОЛИТИКА МАГАЗИНА (ОБЯЗАТЕЛЬНО ЗНАТЬ!):
- **Картой** = цена со СКИДКОЙ (самая выгодная!)
- **Наличными** = та же скидка, что и картой
- **Рассрочка** = цена ВЫШЕ, так как идёт через банк (0-0-12, без переплаты для клиента, но магазин платит комиссию)
- Если клиент спрашивает "сколько в рассрочку?" — бери цену из поля "Рассрочка" в текущей сборке
